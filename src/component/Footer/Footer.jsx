        ...
        <div className="container">
          <div className="flex flex-wrap w-full md:flex-nowrap gap-2 sm:gap-0">
            ...
            <div className="text-left mx-auto mb-4 sm:mb-0">
              ...
              >
                <li>
                  <a href="#" onClick={scrollToTop}>Bachelor in Germany</a>
                </li>
                <li>
                  <a href="#" onClick={scrollToTop}>Masters in Germany</a>
                </li>
                <li>
                  <a href="#" onClick={scrollToTop}>PhD in Germany</a>
                </li>
                <li>
                  <a href="#" onClick={scrollToTop}>MBA in Germany</a>
                </li>
              </ul>
            </div>
            ...
            <div className="text-left mx-auto mb-4 sm:mb-0 ">
              ...
              >
                <li>
                  <a href="#" onClick={scrollToTop}>Study Visa</a>
                </li>
                <li>
                  <a href="#" onClick={scrollToTop}>Accommodation</a>
                </li>
                <li>
                  <a href="#" onClick={scrollToTop}>Service in Germany</a>
                </li>
                <li>
                  <a href="#" onClick={scrollToTop}>Service in India</a>
                </li>
              </ul>
            </div>
            ...
            <div className="text-left mx-auto mb-4 sm:mb-0 ">
              ...
              >
                <li>
                  <a href="#" onClick={scrollToTop}>About</a>
                </li>
                <li>
                  <a href="#" onClick={scrollToTop}>Terms and Condition</a>
                </li>
                <li>
                  <a href="#" onClick={scrollToTop}>Privacy Policies</a>
                </li>
                <li>
                  <a href="#" onClick={scrollToTop}>Refund Policies</a>
                </li>
              </ul>
            </div>
