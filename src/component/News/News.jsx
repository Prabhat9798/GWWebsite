  ...
  return (
    <section className="bg-white py-12 relative overflow-hidden" id="news">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        {/* Section header with centered title and right-aligned button */}
        <div className="flex flex-col sm:flex-row items-center justify-between mb-8 w-full relative">
          <div className="w-full sm:w-auto text-center sm:absolute sm:left-1/2 sm:transform sm:-translate-x-1/2">
            <h2 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-[#FF9422] to-[#D63715] bg-clip-text text-transparent">
        ...
        {/* Blog posts slider with equal height cards and bottom margin */}
        <div className="slider-container px-2 sm:px-0 mb-8">
            ...
            {blogPosts.map((post, index) => (
              <div key={index} className="px-2 sm:px-3 h-full">
                ...
                >
                  ...
                  {/* Blog content with flex-grow for equal height */}
